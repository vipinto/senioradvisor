...
async def create_subscription_payment(payment_request: CreatePaymentRequest, request: Request):
    ...
    try:
        ...
        frontend_url = os.environ.get('CORS_ORIGINS', 'https://ucan-preview.preview.emergentagent.com').split(',')[0]
        if frontend_url == '*':
            frontend_url = 'https://ucan-preview.preview.emergentagent.com'
