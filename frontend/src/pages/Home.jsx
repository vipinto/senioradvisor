        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto" data-testid="hero-section">
            ...
            <p className="text-sm text-gray-500 max-w-2xl mx-auto mb-10">
              Conectamos familias con <span className="font-bold text-[#33404f]">residencias</span> y <span className="font-bold">cuidado a domicilio</span> de confianza.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-3">
              <img src="/logo-senior-podcast.svg" alt="SeniorPodcast" className="h-20" style={{ filter: 'brightness(0) saturate(100%) invert(0.2)' }} />
              <h2 className="text-3xl md:text-4xl font-bold text-[#33404f]">Ve nuestros podcast sobre bienestar y actualidad Senior</h2>
              <p className="text-gray-500 text-sm">Conversaciones, entrevistas y contenido exclusivo para adultos mayores y sus familias</p>
              <div className="pt-3">
                <Link to="/podcast">
                  <Button className="bg-[#00e7ff] hover:bg-[#00d4e8] text-[#33404f] font-bold px-6 py-3 rounded-xl text-sm">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                ...
                <p>Conectamos a familias con <span className="font-semibold">residencias de calidad</span> y <span className="font-semibold text-[#00e7ff]">cuidado a domicilio</span> verificados y confiables.</p>
              </div>
            </div>
          </div>
        </div>
...
const FeaturedGrid = ({ featured }) => {
  ...
  return (
    <section className="py-16 bg-[#00e7ff]/60" data-testid="featured-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-4xl font-bold text-[#33404f] mb-1">Residencias y Cuidados Domiciliarios Destacados</h2>
          <p className="text-[#33404f]/60 text-lg">Los servicios mejor evaluados por las familias</p>
        </div>
        ...
        <div className="text-center mt-10">
          <Link to="/destacados">
            <Button 
              className="bg-[#33404f] text-[#00e7ff] hover:bg-[#4a5568] px-8 py-4 text-base font-bold rounded-xl"
