...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-50 to-white py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-base text-[#00e7ff] hover:underline font-medium" data-testid="forgot-password-link">
          ...
          <div className="text-center text-base text-gray-600">
            ¿No tienes cuenta?{' '}
            <Link to="/register" className="text-[#00e7ff] hover:underline font-bold" data-testid="register-link">
              Regístrate aquí
            </Link>
          </div>
        </div>
