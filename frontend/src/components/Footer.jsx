      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <span className="text-2xl font-bold text-white">SeniorAdvisor</span>
          ...
          <div>
            ...
            <div className="flex gap-3" data-testid="social-links">
              <a href="https://www.instagram.com/senioradvisor.cl" target="_blank" rel="noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-[#2B547E] rounded-lg flex items-center justify-center transition-colors" data-testid="social-instagram" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/senioradvisor.cl" target="_blank" rel="noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-[#2B547E] rounded-lg flex items-center justify-center transition-colors" data-testid="social-facebook" aria-label="Facebook">
