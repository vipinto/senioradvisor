...
const Footer = () => {
  return (
    <footer className="bg-[#33404f] text-gray-300" data-testid="footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3" data-testid="social-links">
              <a href="https://www.instagram.com/SeniorAdvisor.cl" target="_blank" rel="noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-[#00e7ff] rounded-lg flex items-center justify-center transition-colors" data-testid="social-instagram" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/SeniorAdvisor.cl" target="_blank" rel="noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-[#00e7ff] rounded-lg flex items-center justify-center transition-colors" data-testid="social-facebook" aria-label="Facebook">
