      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-200 px-4 py-4 sm:px-6 sm:py-5">
        <div className="flex flex-col sm:flex-row sm:items-end gap-4 sm:gap-3">
          ...
          <div className="flex-1 min-w-0">
            <label className="block text-sm font-bold text-[#33404f] mb-1.5">Region</label>
            <select
          ...
          {/* Comuna */}
          <div className="flex-1 min-w-0">
            <label className="block text-sm font-bold text-[#33404f] mb-1.5">Comuna</label>
            <select
          ...
          {/* Price */}
          <div className="flex-1 min-w-0">
            <label className="block text-sm font-bold text-[#33404f] mb-1.5">Precio</label>
          ...
          <div className="min-w-0 sm:w-[130px] flex-shrink-0">
            <label className="block text-sm font-bold text-[#33404f] mb-1.5">Rating</label>
            <select
              value={minRating}
